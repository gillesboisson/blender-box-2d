...
class Physics2DDistanceAnchorMoveWidget(Physics2DMoveWidget):
    bl_idname = "VIEW3D_GT_physics_2d_distance_anchor_move_widget"
    ...
    def updateShapes(self):
        ...
        self.shapes.append(self.new_custom_shape('LINES',create_circle_line_vertices(radius=0.6)))
