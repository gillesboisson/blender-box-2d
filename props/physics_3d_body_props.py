...
from ..utils.enums import body_orientation_enum
...
class RigidBody3DPropertyGroup(bpy.types.PropertyGroup):
    ...
    shape_type: EnumProperty(name="Shape", items = body_shapes_enum, default='box')
    ...
    shape_orientation: EnumProperty(name="Orientation", items = body_orientation_enum, default='y')
