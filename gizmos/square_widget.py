...
from ..utils.vertices import create_square_vertices, get_x_transposition_vector, get_y_transposition_vector, vec_2_to_vec_3


class SquareWidget(Gizmo):
    bl_idname = "VIEW3D_GT_square_widget"
    ...
    def _update_mat(self):
        ...
        and self.target_is_valid('size')):
            ...
            size = vec_2_to_vec_3(self.orientation,size2d)
    ...
    def setup(self):
        ...
        if hasattr(self, "orientation"):
            verts = (
                create_square_vertices(orientation = self.orientation)
            )
